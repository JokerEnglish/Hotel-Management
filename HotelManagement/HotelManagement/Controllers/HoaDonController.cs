...
namespace HotelManagement.Controllers
{
    public class BillController : Controller
    {
        ...
        public BillController(IBillRepository billRepository, IRentRepository rentRepository, IKhachhangRepository khachhangRepository, INhanvienRepository nhanvienRepository, IPhuthuRepository phuthuRepository, IPhongRepository phongRepository)
        {
        ...
        public async Task<IActionResult> CreateAsync(int khanghangID, int rentID)
        {
            ...
            var employeeList = await _nhanvienRepository.GetAllAsync();
